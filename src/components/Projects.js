    ...
    <section id="projects" className="text-gray-400 bg-gray-100 body-font">
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          <h1 className="sm:text-4xl text-3xl font-medium title-font mb-4 text-slate-600">
            Apps I've Built
          </h1>
      ...
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        For more detailed descriptions of projects, please click <a href="#ProjectDescriptions">here</a>
      </div>
    </section>
  );
}
